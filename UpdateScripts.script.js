...
;// CONCATENATED MODULE: ./src/design-system/components/Button.tsx
...
var Button = function (_a) {
    ...
    return ((0,jsx_runtime.jsx)("button", __assign({ disabled: disabled, onClick: onClick }, { children: (0,jsx_runtime.jsx)("span", { children: children }) })));
};

;// CONCATENATED MODULE: ./src/domain/Scripts.ts
var Scripts = {
    WhisperGM: {
        name: 'Whisper to GM',
...
var log = function (message) {
    console.debug("[GC::Scripts] ".concat(message));
};
...
var createFolderIfNotExists = function () {
    ...
    return Folder.create({
        ...
        type: 'Macro',
        description: 'This folder contains all the scripts used by the GC::Scripts module.',
    });
};
var createEvalCommands = function (scripts) {
    return new Promise(function (resolve) {
        createFolderIfNotExists().then(function (folder) {
            if (!folder) {
                log("Cannot create folder for ".concat(scripts, " command. Folder can not be created."));
...
;// CONCATENATED MODULE: ./src/domain/UpdateScripts/UpdateScriptsModal.tsx
var UpdateScriptsModal_assign = (undefined && undefined.__assign) || function () {
    UpdateScriptsModal_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return UpdateScriptsModal_assign.apply(this, arguments);
};
...
var UpdateScriptsModal = function (_a) {
    var dialog = _a.dialog;
    var scriptsForGm = Object.values(Scripts).filter(function (script) { return script.permissions === 'gm' || script.permissions === 'all'; });
    var scriptsForPlayers = Object.values(Scripts).filter(function (script) { return script.permissions === 'all'; });
    var allScripts = __spreadArray([], scriptsForGm, true);
    var createGMScripts = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createEvalCommands(scriptsForGm)];
                case 1:
                    _a.sent();
                    dialog.close();
                    return [2 /*return*/];
    ...
    var createPlayerScripts = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createEvalCommands(scriptsForPlayers)];
                case 1:
                    _a.sent();
                    dialog.close();
                    return [2 /*return*/];
    ...
    var createAllScripts = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createEvalCommands(allScripts)];
                case 1:
                    _a.sent();
                    dialog.close();
                    return [2 /*return*/];
    ...
    return ((0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h1", { children: "ABF GC:Scripts" }), (0,jsx_runtime.jsx)("p", { children: "Welcome! Choose the scripts you want to update." }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)(Button, UpdateScriptsModal_assign({ onClick: createGMScripts }, { children: "For GM" })), (0,jsx_runtime.jsx)(Button, UpdateScriptsModal_assign({ onClick: createPlayerScripts }, { children: "For Players" })), (0,jsx_runtime.jsx)(Button, UpdateScriptsModal_assign({ onClick: createAllScripts }, { children: "All scripts" })), (0,jsx_runtime.jsx)(Button, UpdateScriptsModal_assign({ onClick: function () { return dialog.close(); } }, { children: "Cerrar" }))] })] }));
};

;// CONCATENATED MODULE: ./src/domain/UpdateScripts/UpdateScripts.script.ts
