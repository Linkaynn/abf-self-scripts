...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".react-dialog {\n  height: auto !important;\n}\n", ""]);
// Exports
...
;// CONCATENATED MODULE: ./src/design-system/components/Input.tsx

var Input = function (_a) {
    var id = _a.id;
    return (0,jsx_runtime.jsx)("input", { id: id, type: "text" });
};

;// CONCATENATED MODULE: ./src/design-system/hooks/useInput.tsx



var useInput = function (initialValue) {
    if (initialValue === void 0) { initialValue = ""; }
    var idRef = (0,react.useRef)(Date.now().toString());
    var getInput = function () {
        return document.getElementById(idRef.current);
    };
    (0,react.useEffect)(function () {
        getInput().value = initialValue;
    }, []);
    return {
        getValue: function () { var _a, _b; return (_b = (_a = getInput()) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : ""; },
        Input: function () { return (0,jsx_runtime.jsx)(Input, { id: idRef.current }); },
    };
};
...
;// CONCATENATED MODULE: ./src/utils/FoundryScripts.ts
...
var GCError = /** @class */ (function (_super) {
    __extends(GCError, _super);
    function GCError(message) {
        return _super.call(this, "[GC::Scripts] ".concat(message)) || this;
    }
    return GCError;
}(Error));
var createDialog = function (title, content) {
    return new Dialog({
        title: title,
        content: content,
        buttons: {
                ...
                yes: {
                    ...
                    callback: function (html) {
                        ...
                        if (stringInputValue.length > 0) {
                            formula += "+".concat(stringInputValue, "[Modificador]");
                        }
                        if (additionalDiceValues !== undefined) {
                            formula += "+".concat(additionalDiceValues);
                        }
                        var dice = new ABFFoundryRoll(formula);
                        dice.roll();
                        resolve(dice);
                    },
                },
...
var getSelectedToken = function () {
    return game.canvas.scene === undefined
        ? undefined
...
var createCharacterControl = function (_a) {
    ...
    custom1d100({
        title: title,
        additionalDiceValues: "".concat(value, "[").concat(name, "]"),
    }).then(function (dice) {
        if (dice.total === undefined)
            return;
        var message = getDifficultyName(dice.total);
        dice.toMessage({
...
;// CONCATENATED MODULE: ./src/domain/WhisperGMModal/WhisperGMModal.tsx
